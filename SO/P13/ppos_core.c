...
int tasks_ids = 0, flag_sistema_usuario = 0, quantum = MAXQUANTUM, saida, semaforos_existem, num_fila_msg; 
...
int mqueue_recv (mqueue_t *queue, void *msg){
    ...
    fila_msg_t *antigo = malloc(sizeof(fila_msg_t));
    antigo->msg = malloc(queue->msg_size);
